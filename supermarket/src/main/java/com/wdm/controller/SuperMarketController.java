...
public class SuperMarketController {
	...
	@PostMapping
	public ResquestSuperMarket saveproduct(@RequestBody ResquestSuperMarket superMarket) {
		return supermodelimpl.save(superMarket);
	...
	public SuperMarketEntity updatesupermodel(@RequestBody SuperMarketEntity superMarket, @PathVariable("id") long superId) {
